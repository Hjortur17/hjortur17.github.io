	...
	render: function() {
		...
		return (
			<section style={imageSection}>
					<Col lg={12}>
						<h1 style={sectionHeader}>Recent Blog Post</h1>
						<Col md={3} style={ColStyle}>
							...
							<a href="./blogPosts/gtr.js"><h3 style={imageKicker}>Nissan GTR</h3></a>
						</Col>
						<Col md={3} style={ColStyle}>
						...
						<Col md={3} style={ColStyle}>
							...
							<a href=""><h3 style={imageKicker}>Porsche Cayenne</h3></a>
						</Col>
					</Col>
			</section>
		);
